...
namespace DotNetBase.Api.Controllers
{
    public class ContactController(ContactService contactService) : Controller
    {
        ...
        public async Task<IActionResult> CreateContactAsync([FromBody] CreateContact createContact)
        {
            try
            {
        ...
        public async Task UpdateContactAsync(int id, [FromBody] UpdateContact updateContact)
        {

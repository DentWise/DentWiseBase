...
namespace DotNetBase.Api.Controllers
{
    public class CompanyController(CompanyService companyService) : Controller
    {
        ...
        public async Task<IActionResult> CreateCompanyAsync([FromBody] CreateCompany createCompany)
        {
            try
            {
        ...
        public async Task UpdateCompanyAsync(int id, [FromBody] UpdateCompany updateCompany)
        {
